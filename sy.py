...
print "\n"
print "~"*60
print "Symlink Bypass 2014 by Bugresearcher "
print "              Special Greetz to : Bugresearcher"
print "~"*60

os.makedirs('Priv8Area')
os.chdir('Priv8Area')
...
sf = "<html><title>Symlink Bypass 2017 by PoYRaZ7221</title><center><font color=black size=5>Symlink Bypass 2017<br><font size=4>Made By PoYRaZ7221 <br>Priv8Area.ORG</font></font><br><font color=black size=3><table>"
